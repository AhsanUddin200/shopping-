...
function SplashScreen({ finishLoading }: { finishLoading: () => void }) {
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      setIsMounted(true);
      animate(); // Call the animate function inside useEffect
    }, 10);

    return () => clearTimeout(timeout);
  }, [finishLoading]); // Make sure to include finishLoading in the dependency array
    ...
    <div className='flex h-screen items-center justify-center'>
      ...
      >
        <Image
          ...
          width={60} // Make sure to provide width and height for Image component
          height={60}
        />
        <motion.div
